...
it('uses a real file row count when the preview is capped', () => {
  render(<StatusBar status="done" elapsedMs="42" returnedRows="1000" visibleRange={[501, 1000]} totalRows="12500" truncated />)
  expect(screen.getByText(/rows 501–1,000 of 12,500/i)).toBeInTheDocument()
})
